...
| File | Size |
|------|------|
| `dist/font-weight.css` | 2065 bytes |
| `dist/font-weight.min.css` | 1333 bytes (282 Gzipped) |
...
| `.fw8` | `font-weight: 800;` |
| `.fw9` | `font-weight: 900;` |
| `.fwn-s` | `font-weight: normal;` |
| `.b-s` | `font-weight: bold;` |
| `.fw-light-s` | `font-weight: lighter;` |
...
Example: `.fwn-m` applies the property at the medium breakpoint and above.
